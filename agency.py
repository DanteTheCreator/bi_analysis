...
class Agency:
    def __init__(self,):
        ...
        self.talker = ConversableAgent(
            ...
            human_input_mode='NEVER',
            system_message="""
            Chat with user. User will be looking for a specific type of data, 
            chat with them and help them define exactly what kind fo data they want.
            Show example table when confident in answer.
            
            Next agent knows the platform, database and every details it needs. NEVER ask for technical details.
            ALWAYS try to find out what kind of columns the user is looking for.
    """,
